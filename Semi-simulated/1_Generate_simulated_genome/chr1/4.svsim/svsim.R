...
write.table(svsim_1,"Haplotype_1.txt",row.names = FALSE,col.names = FALSE,quote = FALSE, sep = "\t")
svsim1_ins <- haplotype_1[haplotype_1[,1]=="insertion",]
write.table(svsim1_ins,"Haplotype_1_insertion.txt",row.names = FALSE,col.names = FALSE,quote = FALSE, sep = "\t")
...
write.table(svsim_2,"Haplotype_2.txt",row.names = FALSE,col.names = FALSE,quote = FALSE, sep = "\t")
svsim2_ins <- haplotype_2[haplotype_2[,1]=="insertion",]
write.table(svsim2_ins,"Haplotype_2_insertion.txt",row.names = FALSE,col.names = FALSE,quote = FALSE, sep = "\t")
