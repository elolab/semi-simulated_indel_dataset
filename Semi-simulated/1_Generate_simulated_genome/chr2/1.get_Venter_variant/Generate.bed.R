...
Haplotype_1 <- read.table("Chr2.haplotype_1.variants_1.txt")
Haplotype_2 <- read.table("Chr2.haplotype_2.variants_1.txt")
...
for (i in 1:dim(Haplotype_1)[1])
{
  ...
  {
      item <- c("chr2",as.character(Haplotype_1[i,2]),as.character(as.numeric(as.character(Haplotype_1[i,2]))+
  ...
  {
    item <- c("chr2",as.character(Haplotype_1[i,2]),as.numeric(as.character(Haplotype_1[i,2]))+1)
    Bed.haplotype_1 <- rbind(Bed.haplotype_1,item) 
  }
}
...
for (i in 1:dim(Haplotype_2)[1])
{
  ...
  {
    item <- c("chr2",as.character(Haplotype_2[i,2]),as.character(as.numeric(as.character(Haplotype_2[i,2]))+
  ...
  {
    item <- c("chr2",as.character(Haplotype_2[i,2]),as.numeric(as.character(Haplotype_2[i,2]))+1)
    Bed.haplotype_2 <- rbind(Bed.haplotype_2,item) 
  }
}
