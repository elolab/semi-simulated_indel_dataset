haplotype_1 <- read.table("chr2.haplotype_1.hg19.txt")
haplotype_2 <- read.table("chr2.haplotype_2.hg19.txt")
...
write.table(variants,"Venter.truthset.chr2.txt",row.names = FALSE,col.names = FALSE,quote = FALSE, sep = "\t")
