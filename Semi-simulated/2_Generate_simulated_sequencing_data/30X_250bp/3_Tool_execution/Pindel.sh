...
#SBATCH -C stable
#SBATCH --mem 32GB
#SBATCH --job-name Pindel.25_5
#SBATCH --error Pindel.25_5.Errors.txt
#SBATCH --output Pindel.25_5.Console.txt

export LD_LIBRARY_PATH
LD_LIBRARY_PATH=/htslib

/pindel/pindel -i simulated_config.txt -f reference_chr1_chr2.fa -o Pindel_simulatedD -T 24 -x 4 -M 4 -l
