...
Platypus_input <- read.table("variants.indel.recode.vcf")
...
parse_length(Platypus_del_data,truthset.deletion,"deletion") 
parse_length(Platypus_ins_data,truthset.insertion,"insertion")
